# 🧠 Stock Price Prediction using LSTM (Master File - Sample Data)
# All 7 steps in one file - Python 3.8 Compatible
...
def step0_install_libraries():
    ...
    packages = ['tensorflow', 'pandas', 'scikit-learn', 'matplotlib', 'numpy']
...
# =============================================================================
# 🔹 Step 1 — Import packages and generate sample data
# =============================================================================

def step1_import_and_generate():
    print("🔹 Step 1 — Import packages and generate sample data")
    print("="*50)
    ...
    # Generate realistic AAPL-like sample data
    print("📊 Generating AAPL sample data...")
    np.random.seed(42)
    ...
    for i in range(len(dates)):
        change = np.random.normal(0.0005, 0.02)  # Small upward trend with volatility
    ...
    print("✅ Step 1 Complete: Sample data generated!\n")
    return df
...
def step2_visualize(df):
    ...
    plt.plot(df["Close"])
    plt.title("Apple Closing Price (Sample Data 2016–2024)")
    plt.xlabel("Date")
...
def step6_plot_results(pred_prices, actual_prices):
    ...
    plt.title("Predicted vs Actual Apple Prices (Sample Data)")
    plt.xlabel("Time")
    plt.ylabel("Price (USD)")
    plt.legend()
    plt.grid(True, alpha=0.3)
...
def main():
    print("🧠 Stock Price Prediction using LSTM (Sample Data Version)")
    print("🔹 Complete 7-Step Pipeline - Python 3.8 Compatible")
    print("="*60)
    ...
    try:
        ...
        print("📝 Note: This uses sample data for Python 3.8 compatibility")
